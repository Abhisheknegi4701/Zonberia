  ...
  if (GetPlatform.isAndroid) {
    await Firebase.initializeApp(
      options: const FirebaseOptions(
        apiKey: "AIzaSyDpKub-_2zYNnIHq4LdRJ3ntoBdTEolxN4",
        appId: "1:229025673140:android:016863e6441ae2bf878ce1",
        messagingSenderId: "229025673140",
        projectId: "ecommerce-cable",
      ),
    );
  } else {
    await Firebase.initializeApp();
